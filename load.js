if (loadImg==NaN||loadImg==undefined){
...
document.getElementsByClassName('loader')[0].innerHTML='<img src='+loadImg+'alt="load-img" class="load-img"><h2>Loading...</h2>';

let loader = document.querySelector('.loader');
window.addEventListener("load", () =>{
    loader.classList.add('loaded');
    addEventListener("animationend", () => {document.querySelector('.body').removeChild(loader)});
});